...
new Standard(){ StandardID = 3, StandardName="Standard 3"}
        ...
        var studentsGroupByStandard = from s in studentList
                                      ...
                                      orderby sg.Key select new { sg.Key, sg };
        ...
        var nestedQueries = from s in studentList
                            where s.Age > 18 && s.StandardID == (from std in standardList where std.StandardName == "Standard 1" select std.StandardID).FirstOrDefault() select s;
